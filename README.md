<p>
	<img src="resources/sage-js.svg" style="width: 70%; margin: 0 auto;">
</p>

# Sage.js

Sage.js is a fully-featured caching Sage client for JS and web apps.
...
In any project you'll need a simple client which manages your data requirements, handles queries, networking, local state of your data.
...
- Describe your app’s data requirements as Sage queries.
- Minimalist.
- 
